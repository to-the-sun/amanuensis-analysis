...
def run_query(query, system_prompt="You are a helpful and concise assistant.", max_new_tokens=128, temperature=0.7):
    pipe = get_pipeline()
    ...
    outputs = pipe(prompt, max_new_tokens=max_new_tokens, do_sample=True, temperature=temperature, top_k=50, top_p=0.95, return_full_text=False)
