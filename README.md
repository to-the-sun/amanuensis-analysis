...
The script generates a Self-Similarity Matrix based on the transient envelope.
...
1. The transient envelope is downsampled to a manageable size (e.g., 400 points).
